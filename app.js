window.document.querySelector(".eb-1 p").addEventListener("click", function () {
  ...
  submainDom.style.width = "900px";
  //   submainDom.style.height = "1500px";
  // document.getElementById("humuunleg"). = "25px";
  window.document.getElementById("p1").innerHTML = "New text";
});
